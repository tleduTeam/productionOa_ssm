			...
			<tr>
				<td valign="top">
					<div style="position:relative;">
						<div style="text-align:right;font-size:15px;margin:1px 0 0 0;">
							<span style="display:inline-block;font-size:15px;color:#c1dff7;margin:0 0 8px 0;">
								计算机科学与技术学院
							</span><br/>
	...
	<div id="HomeFuncAccordion" class="easyui-accordion" style="width:213px;"
		...
		<div title="消息传递" data-options="selected:true" style="padding:10px;">
			<ul id="messageMonitor" class="easyui-tree" data-options="animate:true,lines:true">
				<li><span>消息传递</span>
					<ul>
						<li id=63 data-options="attributes:{'url':'message/find'}">消息管理</li>
					</ul>
					<ul>
						<li id=63 data-options="attributes:{'url':'notice/find'}">公告</li>
					</ul>
				</li>
			</ul>
		</div>
